...
<html lang="en">
 ...
 <!-- Form Registrasi -->
  <div class="container">
    <h3 class="text-center mt-3 mb-5">SILAHKAN TAMBAH KATEGORI</h3>
    <div class="card p-5 mb-5">
      <form method="POST" action="" enctype="multipart/form-data">
        <div class="form-group">
          <label for="menu1">Nama Menu</label>
          <input type="text" class="form-control" id="menu1" name="nama_kategori">
        </div>
        <div class="form-group">
  ...
  if(isset($_POST['tambah'])){
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO kategori_menu VALUES (NULL, '$nama', '$nama_file')");
